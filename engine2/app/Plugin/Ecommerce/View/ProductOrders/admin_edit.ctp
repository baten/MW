...
<div class="">
	...
	<div class="row bar bar-third panel ">
		<div class="col-md-7 well card-1">
			<?php
			echo $this->Form->create('ProductOrder',array('url'=>array('action'=>'edit',$orderid),'class'=>'form'));
		...
		<div class="col-md-5 ">
			<ul class="list-group  card-1">
				...
				<li class="list-group-item"><b>Full name: </b> <?php echo $fname ." ".$lname; ?> </li>
			...
			<div class="col-md-4">
				<ul class="list-group card-1">
					...
					<li class="list-group-item well"> <?php
						...
						echo $this->Form->input('ProductOrder.address_line_1',array('value'=> !empty($address_line_1)? $address_line_1:'','type'=> 'textarea','class'=>'form-control','label'=>'Address Line 1: '));
						echo $this->Form->input('ProductOrder.address_line_2',array('value'=> !empty($address_line_2)? $address_line_2:'','type'=> 'textarea','class'=>'form-control','label'=>'Address Line 2: '));



						echo $this->Form->input('ProductOrder.phone',array('value'=>!empty($phone)? $phone:'','type'=> 'text','class'=>'form-control','label'=>'Phone: '));
						echo $this->Form->input('ProductOrder.state',array('value'=> !empty($state)? $state:'','type'=> 'text','class'=>'form-control','label'=>'City: '));
