				...
				<tr>
					...
					<td>
						<?php
							...
							$available = ($totalStock - $totalSale);
					...
					<td class="text-right action">
						<?php if($totalStock > 0 ): echo $this->Html->link('View', array('controller'=>'stocks','action' => 'view', $product['Product']['title'],$product['Product']['id'],'admin'=>true),array('escape'=>false,'class'=>'btn btn-warning')); endif;?>
					</td>
				</tr>
				<?php endforeach; ?>
				</tbody>
