<div class="row bar bar-primary bar-top">
	<div class="col-md-12">
		<h1 class="bar-title"><?php echo __('Admin Add State'); ?></h1>
	</div>
</div>

<div class="row bar bar-secondary">
	<div class="col-md-12">
		<?php echo $this->Html->link('<i class=\'glyphicon glyphicon-list\'></i> List City', array('action' => 'index',$this->params['pass'][0],'admin'=>true),array('escape'=>false,'class'=>'btn btn-success')); ?>
	</div>	
</div>
