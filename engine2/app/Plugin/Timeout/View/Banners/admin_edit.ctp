<div class="row bar bar-primary bar-top">
	<div class="col-md-12">
		<h1 class="bar-title"><?php echo __('Admin Edit Banner'); ?></h1>
	</div>
</div>
...
<div class="row bar bar-third">
	...
	echo $this->Form->create('Banner',array('class'=>'form','type' => 'file')); 
		...
		echo $this->Form->input('image',array('type'=>'file','onchange'=>'catUploadThumb(this)',  'div'=>array('class'=>'form-group'),'after' => '<spna class="guidance">Image Resulation : (width:1400px) X  (Height:530px)</span>'));
		 
		if(file_exists(WWW_ROOT."/img/site/banners/{$data['Banner']['id']}.{$data['Banner']['image_extension']}")):
			echo $this->Html->image("/img/site/banners/{$data['Banner']['id']}.{$data['Banner']['image_extension']}",array('class'=>'img img-responsive upload-image-thumbnail'))."<br>";
		endif;
