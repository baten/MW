...
<div class="row bar bar-third">
	...
	echo $this->Form->create('Gallery',array('class'=>'form','type'=>'file')); 
		...
		echo $this->Form->input('image',array('type'=>'file','onchange'=>'catUploadThumb(this)',  'div'=>array('class'=>'form-group'),'required'=>true,'after' => '<spna class="guidance">Image Resulation : (width:1080px) X  (Height:300px)</span>'));
