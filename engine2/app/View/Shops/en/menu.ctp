           ...
           <?php   foreach ($arr as $key => $value):
            ...
            <?php           
                echo $this->Form->input('search2', array(
                    ...
                    'legend' => false,
                    'options' => $arr2,                                     
                    'before' => '<div class="col-xs-12 col-sm-12"><div class="thai-radio search2 eng">',
                    'after' => "</div></div>",
                    'div' => false,                                    
                ...
                <div class="col-sm-4">
                 <div class="row"> 
                  <?php echo $this->Form->submit('Search',array('type'=>'submit','class'=>'btn btn-success','label'=>false,'div'=>false));?>
      ...
      <div class="col-xs-12 col-sm-4">
        ...
        <div class="cart-ecom-wrapper">
          <div class="cart-header">
            <P><i class="fa fa-shopping-cart"></i> shopping cart (<span class="countcarttotal flyContainer"><?php echo $quantity;?></span>)</P>
        ...
        <?php foreach ($tocartquery as  $key=>$ele): ?>
         ...
         <?php endforeach; ?>
          ...
          <div class="btn-wrapper ecom">
              <a href="<?php echo $this->webroot;?>shops/checkout" class="btn ecom-btn" type="submit" name="submit">Checkout</a>
        </div>          
        </div>
        </div>
      </div>
