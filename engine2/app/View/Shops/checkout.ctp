      ...
      <div class="col-xs-12 col-sm-8">
        <div class="ecom-checkout">
          <div class="heading">
            ...
            <?php 
              echo $this->Form->input('vorname',array('class'=>'form-control','placeholder'=>'Vorname *','label'=>false,'required'=>true,'div'=>array('class'=>'col-xs-12 col-sm-6')));
              echo $this->Form->input('nacname',array('class'=>'form-control','placeholder'=>'Nachname *','label'=>false,'required'=>true,'div'=>array('class'=>'col-xs-12 col-sm-6')));
              echo $this->Form->input('starbe',array('class'=>'form-control','placeholder'=>'Straße und Hausnummer *','label'=>false,'required'=>true,'div'=>array('class'=>'col-xs-12 col-sm-6')));
              echo $this->Form->input('postcode',array('class'=>'form-control','placeholder'=>'Postleitzahl *','label'=>false,'required'=>true,'div'=>array('class'=>'col-xs-12 col-sm-6')));
              echo $this->Form->input('phone',array('class'=>'form-control','placeholder'=>'Telefon *','label'=>false,'required'=>true,'div'=>array('class'=>'col-xs-12 col-sm-6')));
              ...
              echo $this->Form->input('firma',array('class'=>'form-control','placeholder'=>'Firma (optional) ','label'=>false,'div'=>array('class'=>'col-xs-12 col-sm-6')));
              echo $this->Form->input('etage',array('class'=>'form-control','placeholder'=>'Etage/Hinterhof','label'=>false,'div'=>array('class'=>'col-xs-12 col-sm-6')));
              echo $this->Form->input('OrderNote.message',array('type'=>'textarea','rows'=>2,'class'=>'form-control','placeholder'=>'Ihre Nachricht an uns & besondere Wünsche','label'=>false,'div'=>array('class'=>'col-xs-12 col-sm-12')));
            ?>             
               <div class="col-xs-12">
                  <div class="thai-radio tap ger">
                    <ul>
                       <li><input type="radio" name="data[Order][type]" id="demo1" value="take_away" checked><label for="demo1">Zum Mitnehmen</label></li>
                      <li> <input type="radio" name="data[Order][type]" id="demo2" value="prebook"><label for="demo2">Im Voraus Buchen</label></li>             
                    </ul> 
                  </div>
              </div>

              <div class="col-xs-12 col-sm-12">
                <P class="ecom-text">Lieferzeitpunkt</P>
              </div> 
                  ...
                  <div class="thai-radio">
                    <ul>                     
                      ...
                      echo $this->Form->input('Condition.term', 
                          ...
                          'required'=>true,                                                
                          'before' => '',
                          'after' => '<label class="checkbox" for="term">Ich bin mit den AGB und dem Datenschutz einverstanden.</label>'
                          )); 
                      ?>  
                      <span class="term-link" data-link="<?php echo $this->webroot;?>shops/termAndConditions" onclick="myFunction(this)">Weiterlesen</span>                    
                    </ul>
                     
                  </div>
              </div>
              <div class="col-xs-12 ">
                <p class="payment">Zahlungsmethode wählen</p>
              </div>
              <div class="col-xs-12">
                  <div class="thai-radio">
                    <ul>
                       <li><input type="radio" name="data[Payment][type]" id="cash_on_delivery" value="cash_on_delivery" checked><label for="cash_on_delivery">Barzahlung</label></li>
            ...
            <div class="col-xs-12 send-button text-center">
              <?php  echo $this->Form->button('Zahlungspflichtig bestellen', array('type' => 'submit', 'class' => 'btn', 'label' => false,'disabled'=>$disabled, 'div'=>false));?>
            </div> 
            </div>
      ...
      <div class="col-xs-12 col-sm-4">
        ...
        <div class="cart-ecom-wrapper">
          <div class="cart-header">
            <P><i class="fa fa-shopping-cart"></i> Einkaufswagen (<span class="countcarttotal"><?php echo $quantity;?></span>)</P>
