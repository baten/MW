<?php
	$cakeDescription = __d('cake_dev', 'Thai-Atrium ');
...
<!--===| Search Start |===-->
<?php echo $this->element('shops/en/search_section');?>
<!--===| Search End |===-->

 <!--===| CSS Switcher Start |===-->
 <?php echo $this->element('shops/en/css_switcher');?>
 <!--===| CSS Switcher End |===-->

 <!--===| Pop Up Google Map Start |===-->
<?php echo $this->element('shops/en/popup_google_map');?>
...
<!--===| Header Top Start |===-->
<?php echo $this->element('shops/en/header_top');?>
<!--===| Header Top End |===-->

<!--===| Header  Start |===-->
<?php echo $this->element('shops/en/header',array('controllerName'=>$controllerName,'actionName'=>$actionName));?>
<!--===| Header  End |===-->
...
<?php echo $this->element('shops/en/fixed_book_table');?>
<!--===| Right Fixed Booking Form end|===-->

<!--====| Footer section Start|====-->
<?php echo $this->element('shops/en/footer');?>
<!--====| Footer section Start|====-->

<!--==| offcanvas-menu Start |==-->
<?php echo $this->element('shops/en/mobile_menu',array('controllerName'=>$controllerName,'actionName'=>$actionName));?>
<!--==| offcanvas-menu End |==-->
</div>
